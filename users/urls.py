...
from .views import (activate, activation_complete, register,
                    registration_closed, registration_complete, profile, shift_auth)
urlpatterns = [
    ...
    url(r'^login/$', login,
        {'template_name': 'users/login.html'}, name='users_login'),
    url(r'^logout/$', logout,
        {'template_name': 'users/logout.html'}, name='users_logout'),
    ...
    url(r'profile/', profile,
        {'template_name': 'users/profile.html'}, name='users_profile'),

    url(r'^shift/$', shift_auth, name='shift_auth'),
]
