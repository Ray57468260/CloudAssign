...
from .fields import HoneyPotField, PasswordField, UsersEmailField, UserIDField
...
class UserCreationForm(forms.ModelForm):
    ...
    user_id = UserIDField(label=_('学号'), max_length=10)
    email = UsersEmailField(label=_('电子邮箱'), max_length=255)
...
class UserProfileForm(ModelForm):
    ...
    class Meta:
        model = User
        fields = ['name', 'gender', 'email', 'phonenumber', 'dept', 'major']
