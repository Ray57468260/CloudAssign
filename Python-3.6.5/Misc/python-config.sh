...
prefix="/srv/Project01/env_Project_CA/bin/a"
exec_prefix="${prefix}"
...
LIBPL=$(echo "$(prefix)/lib/python3.6/config-$(VERSION)$(ABIFLAGS)-i386-linux-gnu" | sed "s#$prefix#$prefix_real#")
SO=".cpython-36m-i386-linux-gnu.so"
PYTHONFRAMEWORK=""
